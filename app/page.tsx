...
const flowers = [
  ...
  { id: 'f2', name: 'Орхідея',       img: '/images/f2.jpg' },
  { id: 'f3', name: 'Лотос',         img: '/images/f3.jpg' },
  { id: 'f4', name: 'Ранункулюс',       img: '/images/f4.jpg' },
